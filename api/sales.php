...
* Version: 2.1 (Bug Fix: Syntax error in createSale response)
*/
...
// Clear reports caches
$cacheDir = CACHE_DIR;
if (is_dir($cacheDir)) {
    $files = glob($cacheDir . 'reports*.cache');
    if ($files) {
        foreach ($files as $file) { if (is_file($file)) unlink($file); }
    }
}
// FIX: Corrected syntax error and fetch logic
